...
class MonitorQuarantine extends CI_Model
{
	...
	function get_history_images($mobile_no)
	{
		...
		$qry = "SELECT  tbl_history_image.url,tbl_history_image.filename FROM tbl_history_image 
		INNER JOIN Entity ON Entity.id = tbl_history_image.entity_id WHERE tbl_history_image.mobile_no='" . $mobile_no . "'";
