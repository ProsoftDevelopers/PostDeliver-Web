<?php 
	$host         = "localhost:3308"; // "localhost";
	$username     = "root"; // "root";
	$password     = ""; // "123";
	$dbname       = "userman"; // "test1";
	...
	$sql = "SELECT t2.`id`, t2.`date_of_arrival`, t2.`date_until_quarantined`, t2.`country_of_origin_of_journey`, t2.`port_of_origin_of_journey`, 
