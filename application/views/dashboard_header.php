...
<html>
	<head>
		...
		<link rel="shortcut icon" href="<?php echo base_url(); ?>dist/img/trazer_icon.ico" />
		...
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<!-- SEARCH FORM -->
			<form class="form-inline ml-3" action="<?php echo base_url();?>index.php/Searchc/set_search" method="post">
			  <div class="input-group input-group-sm">
				<input class="form-control form-control-navbar" type="search" placeholder="<?php echo $this->lang->line('search') ?>" aria-label="Search" name="s_text">
